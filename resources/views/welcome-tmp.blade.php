                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">{{$translationHelper->translate('welcome.doc_title','Document')}}</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                            {{ $translationHelper->translate('welcome.doc_text',"
                    ...
                    <a href="https://laracasts.com"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">{{ $translationHelper->translate('welcome.lc_title',"Laracasts")}}</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                            {{ $translationHelper->translate('welcome.lc_text',"Laracasts offers thousands of video tutorials on Laravel, PHP, and JavaScript
                    ...
                    <a href="https://laravel-news.com"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">{{$translationHelper->translate('welcome.lvnews_title',"Laravel News")}}</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">{{
                            $translationHelper->translate('welcome.lvnews_text',"Laravel News is a community driven portal and newsletter aggregating all of the latest
